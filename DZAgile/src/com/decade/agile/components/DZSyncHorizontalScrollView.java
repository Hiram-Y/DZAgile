...
public class DZSyncHorizontalScrollView extends HorizontalScrollView {
	...
	public DZSyncHorizontalScrollView(Context context) {
		super(context);
	}

	public DZSyncHorizontalScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
