...
public class DZKeywordsFlow extends FrameLayout implements OnGlobalLayoutListener{
    ...
    public DZKeywordsFlow(Context context, AttributeSet attrs, int defStyle) {  
        super(context, attrs, defStyle);  
        init();  
    }  
  
    public DZKeywordsFlow(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init();  
    }  
  
    public DZKeywordsFlow(Context context) {  
        super(context);  
        init();  
    }  
