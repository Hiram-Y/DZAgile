...
import com.decade.agile.pulltorefresh.PullToRefreshBase.State;
	...
	public static void overScrollBy(final PullToRefreshBase<?> view,
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				DCLog.d(OverscrollHelper.class, "OverScroll. DeltaX: " + deltaX
						+ ", ScrollX: " + scrollX + ", DeltaY: " + deltaY
						+ ", ScrollY: " + scrollY + ", NewY: " + newScrollValue
						+ ", ScrollRange: " + scrollRange + ", CurrentScroll: "
						+ currentScrollValue);
