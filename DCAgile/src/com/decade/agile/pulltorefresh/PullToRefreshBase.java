...
import com.decade.agile.pulltorefresh.internals.FlipLoadingLayout;
import com.decade.agile.pulltorefresh.internals.LoadingLayout;
import com.decade.agile.pulltorefresh.internals.PullToRefreshUtils;
import com.decade.agile.pulltorefresh.internals.RotateLoadingLayout;
import com.decade.agile.pulltorefresh.internals.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	public void addView(View child, int index, ViewGroup.LayoutParams params) {
		DCLog.d(getClass(), "addView: " + child.getClass().getSimpleName());
	...
	public final void setMode(Mode mode) {
		if (mode != mMode) {
			DCLog.d(getClass(), "Setting mode to: " + mode);
			mMode = mode;
			updateUIForMode();
		}
	}
	...
	final void setState(State state, final boolean... params) {
		mState = state;
		DCLog.d(getClass(), "State: " + mState.name());
	...
	protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		DCLog.d(getClass(), String.format("onSizeChanged. W: %d, H: %d", w, h));
	...
	protected final void refreshLoadingViewsSize() {
		...
		DCLog.d(getClass(), String.format(
	...
	protected final void setHeaderScroll(int value) {
		...
		DCLog.d(getClass(), "setHeaderScroll: " + value);
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			ViewCompat
					.setLayerType(mRefreshableViewWrapper, value != 0 ? 2 : 0);
		}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			...
			PullToRefreshUtils.warnDeprecation("ptrAdapterViewBackground",
