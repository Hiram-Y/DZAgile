...
import com.decade.agile.pulltorefresh.internals.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
	...
	public final void onScroll(final AbsListView view,
		...
		DCLog.d(getClass(), "First Visible: " + firstVisibleItem
	...
	public final void onScrollStateChanged(final AbsListView view,
		 ...
		 * visible.
		 */
		DCLog.d(getClass(), "mLastItemVisible="+mLastItemVisible + "state= "+state + mOnLastItemVisibleListener);
		if (state == OnScrollListener.SCROLL_STATE_IDLE || state == OnScrollListener.SCROLL_STATE_FLING) {
			if(null != mOnLastItemVisibleListener && mLastItemVisible){
	...
	private boolean isFirstItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			DCLog.d(getClass(), "isFirstItemVisible. Empty View.");
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			DCLog.d(getClass(), "isLastItemVisible. Empty View.");
			...
			DCLog.d(getClass(), "isLastItemVisible. Last Item Position: "
