...
public class DCForm {
	...
	protected ArrayList<DCAbstractValidate> _validates = new ArrayList<DCAbstractValidate>();
	
	/**
	 * Function adding Validates to our form
	 * @param validate
     *   {@link DCAbstractValidate} Validate to add
	 */
	public void addValidates(DCAbstractValidate validate){
	...
	public boolean validate(){
		boolean result = true;
		Iterator<DCAbstractValidate> it = this._validates.iterator();
		while(it.hasNext()){
			DCAbstractValidate validator = it.next();
