...
public class DCMobileValidator extends DCAbstractValidator {

	private int _errorMessage;
	private int _emptyMsg;
	private int _formErrorMsg;

	public DCMobileValidator(Context c) {
		super(c);
		_errorMessage = R.string.validator_phone_error;
	}

	public DCMobileValidator(Context c, int emptyMsg, int formErrorMsg) {
		super(c);
		_emptyMsg = emptyMsg;
