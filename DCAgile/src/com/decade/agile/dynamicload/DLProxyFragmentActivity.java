...
import com.decade.agile.dynamicload.DLProxyImpl.DLProxy;

public class DLProxyFragmentActivity extends DCAgileActivity implements DLProxy {

    protected DLPlugin mRemoteActivity;
    private DLProxyImpl impl;
    private DLPluginManager mPluginManager;
    protected DLBackStack backStack;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        backStack = DLBackStack.create();
        impl = new DLProxyImpl(this,backStack);
    ...
    protected void onDestroy() {
        backStack.finish(mRemoteActivity);
