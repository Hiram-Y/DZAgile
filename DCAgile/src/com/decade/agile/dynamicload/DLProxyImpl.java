...
public class DLProxyImpl {
    ...
    protected DLBackStack _backStack;


    public DLProxyImpl(Activity activity,DLBackStack backStack) {
        mActivity = activity;
    ...
    public void onCreate(Intent intent) {
        ...
        int mode = intent.getIntExtra(DLConstants.LAUNCH_MODE,DLConstants.LAUNCH_MODE_STANDARD);
    ...
    protected void launchTargetActivity(int mode) {
        try {
            ...
            mRemoteActivity = _backStack.getPlugin((DLPlugin) instance,mode);
            ...
            if (mRemoteActivity == null) {
                ...
                throw new ClassCastException(
                        "plugin activity must implements DLPlugin");
            }
            ...
            bundle.putInt(DLConstants.LAUNCH_MODE, mode);
