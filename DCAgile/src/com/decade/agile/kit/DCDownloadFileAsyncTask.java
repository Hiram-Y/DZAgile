 ...
 * @date: 2013-10-30
 */
public class DCDownloadFileAsyncTask extends
	...
	public DCDownloadFileAsyncTask(String url, DCDownloadCallback callback) {
	...
	protected String getFileName() {
		return DCFileUtils.getFileNameFromUrl(_url);
	}
