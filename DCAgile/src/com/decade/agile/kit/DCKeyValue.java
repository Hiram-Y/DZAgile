...
public class DCKeyValue {
	 ...
	 */
	public DCKeyValue(Context context, String kvName, int mode) {
	 ...
	 * @return 引用的KV对象。
	 */
	private DCKeyValue put(String key, Object value) {
		if (value == null) {
			...
			DCLog.w(getClass(),"值不是Boolean, Integer, Byte, Long, Float, String的类型之一，将调用它的toString()进行保存");
	 ...
	 * @return 引用的KV对象。
	 */
	public DCKeyValue remove(String key) {
		mEditor.remove(key);
		return this;
	}
