 ...
 * @date: 2013-5-8
 */
public class DCTitleSlideViewPager extends LinearLayout {
	...
	public DCTitleSlideViewPager(Context context) {
		super(context);
		init(context);
	}

	public DCTitleSlideViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
