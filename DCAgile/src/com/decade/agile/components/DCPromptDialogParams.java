...
import com.decade.agile.components.DCDialog.PromptBtnCallback;
 ...
 * @date: 2013-6-3
 */
public class DCPromptDialogParams extends DCBaseDialogParams implements Serializable{
	...
	public DCPromptDialogParams() {
	}

	public DCPromptDialogParams(String title) {
		setTitle(title);
	}

	public DCPromptDialogParams(String title, String content) {
		setTitle(title);
		setContent(content);
	}
	
	public DCPromptDialogParams(String title, String content,String center) {
		setTitle(title);
		setContent(content);
		setCenterBtnText(center);
	}

	public DCPromptDialogParams(String title, String content, String left,
			String right) {
		setTitle(title);
		setContent(content);
		setLeftBtnText(left);
