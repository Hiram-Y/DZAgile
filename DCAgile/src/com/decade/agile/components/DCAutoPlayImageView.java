...
import com.decade.agile.volley.DCVolleyHelper;
 ...
 * @date: 2013-5-8
 */
public class DCAutoPlayImageView extends FrameLayout {

	private TextView autoplay_title_tv;
	private Context _context;
	private ViewPager _viewPager;
	private DCPageIndicator autoplay_indicator;
	...
	public DCAutoPlayImageView(Context context) {
		super(context);
		init(context);
	}

	public DCAutoPlayImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void initViewPager() {
		...
		autoplay_indicator = (DCPageIndicator) pagerLayout
	...
	public static class DCAutoPlayImage extends ImageView {
		...
		public void initImageView(Context context, String url, int defaultImage) {
			...
			DCVolleyHelper.getInstance(context).getmImageLoader()
					.get(url, listener);
