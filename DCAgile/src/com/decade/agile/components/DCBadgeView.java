 ...
 * @author Jeff Gilfelt
 */
public class DCBadgeView extends TextView {
	...
	public DCBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public DCBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public DCBadgeView(Context context, View target) {
     ...
     */
	public DCBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public DCBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public DCBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
