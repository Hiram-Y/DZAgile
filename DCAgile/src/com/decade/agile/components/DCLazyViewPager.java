 ...
 */
public class DCLazyViewPager extends ViewGroup {
    ...
    /**
     * Simple implementation of the {@link android.support.v4.view.DCLazyViewPager.OnPageChangeListener} interface with stub
     * implementations of each method. Extend this if you do not intend to override
     * every method of {@link android.support.v4.view.DCLazyViewPager.OnPageChangeListener}.
     */
    ...
    public DCLazyViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public DCLazyViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
