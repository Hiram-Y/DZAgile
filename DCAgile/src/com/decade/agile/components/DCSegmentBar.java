...
public class DCSegmentBar extends LinearLayout implements OnClickListener {
	...
	public DCSegmentBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	...
	public DCSegmentBar(Context context) {
		super(context);
		mContext = context;
	}
