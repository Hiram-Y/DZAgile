...
import com.decade.agile.kit.DCMoveBg;
 ...
 * @date: 2013-6-26
 */
public class DCSegmentSlideBar extends RelativeLayout implements OnClickListener{
	 ...
	 * @param attrs
	 */
	public DCSegmentSlideBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		_context = context;
	...
	public void addTitle(String title){
		...
		itemWidth = DCApplication.getApp().getWorkSpaceWidth()/_titles.size();
	...
	public void onClick(View v) {
		...
		DCMoveBg.moveFrontBg(slide_tv, startX, itemWidth * tag, 0, 0);
