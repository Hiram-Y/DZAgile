...
public class DCSwipeDismissListView extends ListView {
	/**
	 * 认为是用户滑动的最小距离
	 */
	private int mSlop;
	...
	public DCSwipeDismissListView(Context context) {
		this(context, null);
	}

	public DCSwipeDismissListView(Context context, AttributeSet attrs) {
