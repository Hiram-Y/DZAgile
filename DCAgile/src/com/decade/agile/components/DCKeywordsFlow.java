...
public class DCKeywordsFlow extends FrameLayout implements OnGlobalLayoutListener{
    ...
    public DCKeywordsFlow(Context context, AttributeSet attrs, int defStyle) {  
        super(context, attrs, defStyle);  
        init();  
    }  
  
    public DCKeywordsFlow(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init();  
    }  
  
    public DCKeywordsFlow(Context context) {  
        super(context);  
        init();  
    }  
