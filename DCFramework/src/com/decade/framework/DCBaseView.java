...
public abstract class DCBaseView {
	...
	private View _view;
	private DCBaseViewActivity _parent;
	private DCiReceiveData _receiveData = null;
	...
	public DCBaseView(ViewGroup root, DCBaseViewActivity parent) {
		_root = root;
		_parent = parent;
		_inflater = LayoutInflater.from(parent);
	}

	protected final void setReceiveDataListener(DCiReceiveData listener) {
	...
	public final void startPage(int viewId, Object data, boolean openCache) {
		DCBaseView view = _parent.getView(viewId);
	...
	public final void startPage(DCBaseView view, Object data,
	...
	private final void bindView(View view) {
		DCViewProcessor.bind(view, this);
	}
	...
	public Animation getEnterViewAnimation() {
		...
		ScaleAnimation scaleAnimation = new ScaleAnimation(0.0f, 1.0f, 0.0f,
				1.0f, DCApplication.getApp().getWorkSpaceWidth(), 0.0f);
		scaleAnimation.setDuration(500);

		TranslateAnimation animation = new TranslateAnimation(0.0f, 0.0f,
				DCApplication.getApp().getWorkSpaceHeight(), 0.0f);
	...
	public Animation getExitViewAnimation() {
		...
		ScaleAnimation scaleAnimation = new ScaleAnimation(1.0f, 0.0f, 1.0f,
				0.0f, DCApplication.getApp().getWorkSpaceWidth(), 0.0f);
		scaleAnimation.setDuration(500);
		TranslateAnimation animation = new TranslateAnimation(0.0f, 0.0f, 0.0f,
				DCApplication.getApp().getWorkSpaceHeight());
		animation.setDuration(500);
		animationSet.addAnimation(scaleAnimation);
		animationSet.addAnimation(animation);
		return animationSet;
	...
	public final DCBaseViewActivity getParent() {
		return _parent;
	}
