...
public class DCEncryptTool {
	...
	private static DCEncryptTool _encrypt;
	public static final String KEY = "ajec2pf1gnv6xzbr";

	public DCEncryptTool() throws NoSuchAlgorithmException,
	...
	public static DCEncryptTool getInstance() {

		if (_encrypt == null) {
			try {
				_encrypt = new DCEncryptTool();
			} catch (Exception e) {
				e.printStackTrace();
				DCLog.e(DCEncryptTool.class, "DCEncryptTool init error");
			}
		}
		return _encrypt;
	}
	...
	public String encrypt(String keyData, String str) {
		...
		try {
			...
			DCLog.i(getClass(), "encrypt success");
	...
	public String decrypt(String keyData, String encryptedData) {
		...
		try {
			...
			DCLog.i(getClass(), "decrypt success");
