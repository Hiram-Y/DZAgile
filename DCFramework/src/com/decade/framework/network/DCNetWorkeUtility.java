 ...
 * @date: 2013-5-17
 */
public class DCNetWorkeUtility {
	private static final int TIMEOUT_CONNECTION = 1000 * 15;
	private static final int DEFAULT_SOCKET_BUFFER_SIZE = 8192;
	private static final String VERSION = "0.1.0";
	private static DCRetryHandler _retryHandler = new DCRetryHandler(3);

	public static String requestHttpPost(String url, String params)
			throws IOException {
		DCLog.d(DCNetWorkeUtility.class, "Post: " + url + params);
	...
	public static String requestHttpGet(String url, String params)
			throws IOException {
		DCLog.d(DCNetWorkeUtility.class, "Get: " + url + params);
		return requestHttpGet(new HttpGet(params));
	}

	public static String requestHttpPost(String url, DCRequestParams params)
			throws IOException {
		DCLog.d(DCNetWorkeUtility.class,
	...
	public static String requestHttpGet(String url, DCRequestParams params)
			throws IOException {
		DCLog.d(DCNetWorkeUtility.class,
	...
	private static String sendRequest(final HttpRequestBase httpRequestBase)
		...
		try {
			...
			DCLog.d(DCNetWorkeUtility.class, "Result = " + result);
			return result;
		} catch (IOException e) {
			throw e;
		} finally {
	...
	private static ClientConnectionManager getClientConnectionManager(
		...
		try {
			...
			SSLSocketFactory sf = new DCSSLSocketFactory(trustStore);
	...
	public static String upLoadPhoto(String actionUrl,
		...
		if (files != null) {
			...
			if (res == 200) {
				...
				result = br.readLine();
				DCLog.e(DCNetWorkeUtility.class, "result : " + result);
				input.close();
			}
			outStream.close();
			conn.disconnect();
	...
	private static ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
		...
		public synchronized String handleResponse(HttpResponse response)
			...
			DCLog.e(DCNetWorkeUtility.class, "StatusCode = "
	...
	private static HttpEntity paramsToEntity(DCRequestParams params) {
