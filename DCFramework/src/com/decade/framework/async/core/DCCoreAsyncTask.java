package com.decade.framework.async.core;
...
public abstract class DCCoreAsyncTask<Params, Progress, Result> {
     ...
     *         {@link DCCoreAsyncTask.Status#RUNNING} or {@link DCCoreAsyncTask.Status#FINISHED}.
     *
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
     * @see #execute(Runnable)
     */
    public final DCCoreAsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	public final DCCoreAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        @SuppressWarnings("rawtypes")
		final DCCoreAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(@SuppressWarnings("rawtypes") DCCoreAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
